...
bam_files <- c(system.file("extdata", "NORM1_chr19_trim.bam", package = "DAMEfinder"),
               system.file("extdata", "CRC1_chr19_trim.bam", package = "DAMEfinder"))

vcf_files <- c(system.file("extdata", "NORM1.chr19.trim.vcf", package = "DAMEfinder"),
               system.file("extdata", "CRC1.chr19.trim.vcf", package = "DAMEfinder"))
...
bam.file <- system.file("extdata", "NORM1_chr19_trim.bam", package = "DAMEfinder")

vcf.file <- system.file("extdata", "NORM1.chr19.trim.vcf", package = "DAMEfinder")
