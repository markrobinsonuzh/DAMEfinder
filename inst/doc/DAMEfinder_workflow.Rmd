...
1. Get a `VCF` file from your species 
[dbSNP](https://www.ncbi.nlm.nih.gov/variation/docs/human_variation_vcf/)
[ftp site](ftp://ftp.ncbi.nih.gov/snp/organisms/human_9606_b150_GRCh37p13/VCF/)
[ensembl](http://www.ensembl.org/info/data/ftp/index.html)
[ftp site](ftp://ftp.ensembl.org/pub/grch37/release-91/variation/vcf/homo_sapiens/)

2. Load that file into R with `vcfR`. For more info on this package click [here](https://knausb.github.io/vcfR_documentation/index.html)


TODO: Add extra function to take a vcfile with common SNPs and only take tuples that are close to a SNP. Also remove CpG sites on a SNP

TODO: If the user fails to provide one, we just filter for NAs and stuff
