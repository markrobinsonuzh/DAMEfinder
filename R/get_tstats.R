...
#' genomic position of that tuple, to perform the smoothing.
#' The function takes a \code{RangedSummarizedExperiment} generated by \code{\link{calc_derivedasm}} 
#' or \code{\link{calc_asm}} containing ASM across samples, and the index of control and treatment samples.
