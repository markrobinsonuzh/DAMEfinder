...
#'
#' This function uses the Simes method to calculate a regional-level p-value based on 
#' the single-eBayes p-values. It goes into \code{\link{regionFinder} to summarize each
#' region detected.
#'
#' For positively correlated P-values, Simes’ method is
#' even closer to the nominal α level than the
